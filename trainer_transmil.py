...
def train_transmil(datasets,
    ...
    model = TransMIL(dim=feature_dim, 
                     n_classes=n_classes)
    _ = model.to(device)
...
if __name__ == "__main__":
    ...
    save_dir = './save_weights/unitopatho_transmil_imagenet/'
    ...
    for step, name in enumerate(csv_path):
        ...
        train_transmil((train_dataset, val_dataset, test_dataset),
                     save_path=save_dir,
                     feature_dim = 512,
                     n_classes = 6,
                     fold = step,
